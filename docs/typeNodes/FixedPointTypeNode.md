...
| `display`    | [`UnitNumberDisplayNode`](../displayNodes/UnitNumberDisplayNode.md) _(optional)_ | Display metadata describing how the quantity is presented — a contextual unit resolved via injection on top of the static scale.                                                                                                                                                                                                                                             |
