...
import { examples } from './SentinelCountNode.examples';

export const sentinelCountNode = defineNode('sentinelCountNode', {
    docs: [
    ...
    attributes: [
        optionalAttribute('strategy', enumeration('sentinelCountStrategy'), {
            docs: [
        ...
        attribute('sentinel', node('constantValueNode'), {
            docs: ['The fixed-size constant compared against the bytes at each item position.'],
        }),
    ],
    examples,
});
